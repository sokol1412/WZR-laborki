...
void RysujScene()
{
	GLfloat BlueSurface[] = { 0.3f, 0.3f, 0.8f, 0.5f};
	GLfloat DGreenSurface[] = { 0.1f, 0.8f, 0.05f, 0.3f};
	GLfloat RedSurface[] = { 0.8f, 0.2f, 0.1f, 0.5f};
	GLfloat GreenSurface[] = { 0.5f, 0.6f, 0.35f, 1.0f};
...
void ZmianaRozmiaruOkna(int cx,int cy)
{
	...
	glLoadIdentity();
	gluPerspective(38, aspect, 1, 10000.0);
