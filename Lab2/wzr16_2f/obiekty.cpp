...
ObiektRuchomy::ObiektRuchomy(Teren *teren)
{
  ...
  ilosc_paliwa = 3.0;
	...
	dl_przod = 3.0;     // odleg³oœæ od przedniej osi do przedniego zderzaka 
...
Teren::Teren()
{
   int wynik = tworz_z_obj(&siatka,"planeta1.obj");      // wczytanie siatki tójk¹tów z formatu *.obj (Wavefront)
   if (wynik == 0)
     int wynik = tworz_z_obj(&siatka,"..//planeta1.obj");      // wczytanie siatki tójk¹tów z formatu *.obj (Wavefront)
